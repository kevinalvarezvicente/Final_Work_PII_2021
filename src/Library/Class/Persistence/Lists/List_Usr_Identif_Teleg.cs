...
{
    public class List_Usr_Identif_Teleg{
        [JsonInclude]
        public static List<AdministratorUser> list_AdminUser = new List<AdministratorUser>();
 
        private static List_Usr_Identif_Teleg instance;

        [System.Text.Json.Serialization.JsonConstructor]
        public List_Usr_Identif_Teleg()
        {
            Initialize();
        }
        ...
        public static List_Usr_Identif_Teleg Instance
        {
            get{
                if (instance == null)
                {
                    instance = new List_Usr_Identif_Teleg();
                }
